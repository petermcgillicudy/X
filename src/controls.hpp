...
public:
          ...
          m_selectionBg(Blue)
    {
        ...
        m_editBox->setBackgroundColor(Blue);
        m_editBox->setFocus(m_hasFocus);
        ...
        if (!ev.isMouseEvent) {
            if (ev.isSpecial) {
                if (ev.keyCode == KeyCode::Up) {  // Up arrow
                    if (m_cursorY > 0) {
                        setCursorPos(m_cursorX, m_cursorY - 1, ev.shift);
                        return true;
                    }
                }
                ...
                //     if (m_cursorX > 0) {
                //         setCursorPos(m_cursorX - 1, m_cursorY);
                //         return true;
                //     }
                // }
                ...
                //     }
                // }
                // if (ev.keyCode == KeyCode::Home) {  // Home
                //     setCursorPos(0, m_cursorY);
                //     return true;
                // }
                // if (ev.special == "\033[F") {  // End
                //     if (m_cursorY < m_lines.size()) {
                //         setCursorPos(m_lines[m_cursorY].length(), m_cursorY);
                //         return true;
                //     }
                // }
            ...
            if (relX >= 0 && relX < m_width && relY >= 0 && relY < m_height) {
                ...
                if (lineIndex < m_lines.size()) {
                    ...
                    if (ev.button == ButtonPressed::Left) {
                        ...
                        setCursorPos(charIndex, lineIndex, ev.shift);
                    ...
                    else if (ev.button == ButtonPressed::Release && m_selection) {
    ...
    void setCursorPos(size_t x, size_t y, bool withShift = false) {
